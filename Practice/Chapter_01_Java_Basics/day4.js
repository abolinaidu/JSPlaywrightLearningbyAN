...
//hoisting local scope with let[it is blocked scope]
let z = "global scope";
if (true) {
   console.log(z); // it will become local variable and will be in TDZ [block scope]
     //let z = "blocked  scope"; // Error :intialization of z is not possible for let keyword. It will throw a ReferenceError if we try to access it before declaration.
...
const m = "global scope";
 ...
 const pi =3.14;
 const prod_api_url ="https://gmail.com";
 console.log (pi); // 3.14;
 console.log(prod_api_url); // https://gmail.com
 
 // prod_api_url = "https://yahoo.com"; // TypeError: Assignment to constant variable.

 //Hoisting with var
var n = "global scope";
if (true) {
    console.log(n); // it will become local variable and will be in TDZ [block scope]
}